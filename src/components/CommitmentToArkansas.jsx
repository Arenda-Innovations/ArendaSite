...
const CommitmentToArkansas = () => {
    ...
    return (
      <section className="bg-black text-white py-24 px-6 md:px-12 relative overflow-hidden" id="commitment-to-arkansas">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-lg md:text-xl text-white/90 leading-relaxed">
                    At Arenda, we are deeply committed to the state of Arkansas and its future.
                    Our mission extends beyond innovation—we are building a legacy of excellence
                    that will benefit our local communities and the entire state.
                  </p>
  
                  <p className="text-lg md:text-xl text-white/90 leading-relaxed">
                    Through our research initiatives, educational programs, and community partnerships,
                    we are fostering the next generation of Arkansas innovators who will drive
                    economic growth and technological advancement across our great state.
                  </p>
                </div>
              </div>
            </div>

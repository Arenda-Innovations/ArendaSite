...
export const RightBracket = ({resize=1}) => {
  const height = 50*resize;
  const heightString = height + 'px';
  console.log("R");
  console.log(heightString);
  return (
    <div className={`transform rotate-180 `}>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 27 78" aria-hidden="true" width="50px" height={heightString}>
...
export const LeftBracket = ({resize=1}) => {
  const height = 50*resize;
  const heightString = height + 'px';
  console.log("L");
  console.log(heightString);
